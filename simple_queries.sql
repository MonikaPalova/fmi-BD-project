...
select CLIENTS.ID as client_id, CLIENTS.name as client_name, PURCHASES.PLACEDATE as placedate, PRODUCTS.PRICE*PURCHASES.QUANTITY as value
from CLIENTS,PURCHASES,products
where CLIENTS.ID=PURCHASES.CLIENTID and PURCHASES.PRODUCTID=PRODUCTS.ID and CLIENTS.NAME = 'Spas Naidenov';
